...
#==============================================================
    ...
    t       time (years, vector array) (numpy)
    T       (Temperature, K) (numpy)
    P       (Precipitation, mm/day) (numpy)
    RH      (Relative Humidity, %) (numpy)
    d18Os   (Isotope Ratio of Soil Water) (numpy)
    d18Op   (Isotopes Ratio of Precipitation) (numpy)
    d18Ov   (Isotope Ratio of Ambient Vapor at Surface Layer) (numpy)
